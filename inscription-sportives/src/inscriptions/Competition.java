...
//		return (Date.before(dateCloture));
...
//		return dateCloture.isAfter(LocalDate.now());
	...
	{
		if(dateCloture.equals(this.dateCloture) && dateCloture.isAfter(this.dateCloture)) 
			this.dateCloture = dateCloture;
		else
			return;
	...
	{
		while (dateCloture.isBefore(LocalDate.now()))
			return true;
